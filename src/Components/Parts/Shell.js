...
// cyl
let cylinder = new THREE.CylinderGeometry(radius_bot, radius_top,length, 100 );
...
let cylinder2 = new THREE.CylinderGeometry(radius_bot+thickness, radius_top+thickness,length, 100 );
